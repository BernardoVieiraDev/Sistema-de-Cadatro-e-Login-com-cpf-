...
import models.home_interface as home_interface
import models.registration_interface as registration_interface
from models.utils import \
    carregar_imagem  # Importe a função de carregar as imagens
...
class LoginInterface:
    def __init__(self):
        ...
        self.label_title = tk.Label(
            self.frame, text="Login", font=("Arial", 16, "bold"), bg="white"
        )
        ...
        self.btn_register_page_link = tk.Button(
            self.frame,
            text="Cadastre-se",
            font=("Arial", 10),
            fg="#158aff",
    ...
    def login(self):
        ...
        if not self.bd.check_login(name, password):
            messagebox.showerror("Erro", "Usuário ou senha incorretos ou não cadastrado.")
            return
